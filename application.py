from flask import Flask, render_template, url_for, request, redirect, jsonify, session as login_session, make_response, flash
import random
import string
...
def add_item():
	...
	if request.method == 'POST':
		newItem = Item(name = request.form['name'], category_id = request.form['category'], description = request.form['description'])
		session.add(newItem)
		session.commit()
